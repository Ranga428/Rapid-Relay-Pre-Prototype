...
# Default count = 1. Override by calling: ./stress_danger.sh 31
COUNT=${1:-1}
...
python stress_test_gen.py --scenario danger --supabase --count "$COUNT" || { echo "ERROR: DANGER insert failed."; exit 1; }
