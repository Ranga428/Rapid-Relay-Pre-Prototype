...
STRESS_CSV="$SCRIPT_DIR/../../data/stress_test/stress_danger.csv"

echo ""
echo "============================================================"
echo " Rapid Relay EWS - Stress Test Pipeline [DANGER]"
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario danger --days 30 --csv || { echo "ERROR: CSV generation failed."; exit 1; }
echo "      Done. CSV saved to data/stress_test/stress_danger.csv"
echo ""
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario danger --supabase --count 1 --after-csv "$STRESS_CSV" || { echo "ERROR: Supabase insert failed."; exit 1; }
echo "      Done. Live DANGER row inserted into Supabase."
echo ""

echo "============================================================"
echo " DONE - DANGER stress test pipeline complete."
