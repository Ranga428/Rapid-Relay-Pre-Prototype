...
REM Default count = 1. Override by calling: stress_watch.bat 31
SET COUNT=1
...
python stress_test_gen.py --scenario watch --supabase --count %COUNT%
if %ERRORLEVEL% neq 0 (
    echo ERROR: WATCH insert failed.
    pause
    exit /b %ERRORLEVEL%
)
