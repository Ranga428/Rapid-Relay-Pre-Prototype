...
SET STRESS_CSV=D:\Rapid-Relay\Rapid-Relay-Pre-Prototype\flood_preprototype\data\stress_test\stress_watch.csv
...
cd /d "%SCRIPTS_DIR%"
python stress_test_gen.py --scenario watch --supabase --count 1 --after-csv "%STRESS_CSV%"
if %ERRORLEVEL% neq 0 (
