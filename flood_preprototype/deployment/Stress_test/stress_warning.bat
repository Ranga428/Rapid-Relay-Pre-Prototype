...
SET STRESS_CSV=D:\Rapid-Relay\Rapid-Relay-Pre-Prototype\flood_preprototype\data\stress_test\stress_warning.csv
...
cd /d "%SCRIPTS_DIR%"
python stress_test_gen.py --scenario warning --supabase --count 1 --after-csv "%STRESS_CSV%"
if %ERRORLEVEL% neq 0 (
