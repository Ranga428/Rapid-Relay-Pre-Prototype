...
STRESS_CSV="$SCRIPT_DIR/../../data/stress_test/stress_clear.csv"
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario clear --days 30 --csv || { echo "ERROR: CSV generation failed."; exit 1; }
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario clear --supabase --count 1 --after-csv "$STRESS_CSV" || { echo "ERROR: Supabase insert failed."; exit 1; }
