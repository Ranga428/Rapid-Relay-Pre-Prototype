...
# Default count = 1. Override by calling: ./stress_warning.sh 31
COUNT=${1:-1}
...
python stress_test_gen.py --scenario warning --supabase --count "$COUNT" || { echo "ERROR: WARNING insert failed."; exit 1; }
