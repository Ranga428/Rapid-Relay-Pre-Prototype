...
STRESS_CSV="$SCRIPT_DIR/../../data/stress_test/stress_watch.csv"

echo ""
echo "============================================================"
echo " Rapid Relay EWS - Stress Test Pipeline [WATCH]"
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario watch --days 30 --csv || { echo "ERROR: CSV generation failed."; exit 1; }
echo "      Done. CSV saved to data/stress_test/stress_watch.csv"
echo ""
...
cd "$SCRIPTS_DIR"
python stress_test_gen.py --scenario watch --supabase --count 1 --after-csv "$STRESS_CSV" || { echo "ERROR: Supabase insert failed."; exit 1; }
echo "      Done. Live WATCH row inserted into Supabase."
echo ""

echo "============================================================"
echo " DONE - WATCH stress test pipeline complete."
